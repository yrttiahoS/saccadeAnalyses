function plotEyeDistAnimation(DATA, HEADERS, figtitle, delaytime, accepted_validities, varargin)
%Function plotEyeDistAnimation(DATA, HEADERS, figtitle, delaytime, accepted_validities, varargin)
%
...
rdc = findColumnNumber(HEADERS, 'DistanceRightEye');
ldc = findColumnNumber(HEADERS, 'DistanceLeftEye');

valr = DATA{findColumnNumber(HEADERS, 'ValidityRightEye')};
vall = DATA{findColumnNumber(HEADERS, 'ValidityLeftEye')};
...
starttime = getValue(DATA, 1, findColumnNumber(HEADERS, 'TETTime'));
