function hfig = plotGazeAnimation(DATA, HEADERS, columns, figtitle, delaytime, accepted_validities, savegaze, imageparameters, aois, markertimes, disptext)
...
% columns to use
xgl = columns(1); % findColumnNumber(HEADERS, 'CombinedX');
ygl = columns(2); %findColumnNumber(HEADERS, 'CombinedY');
