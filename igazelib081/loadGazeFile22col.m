function [DATA, HEADERS] = loadGazeFile22col(file)
...
%Read header lines
HEADERS = textscan(str, '%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s', 1);

%Read data columns
%DATA = textscan(str, '%d32 %d32 %d32 %f %d32 %d32 %d32 %f %d32 %f %f %f %f %f %f %d32 %f %f %f %f %f %f %d %d %s %s %d %s', 'HeaderLines',1, 'Delimiter', '\t');
DATA = textscan(str, '%f %f %f %f %f %f %f %f %f %f %d32 %d32 %f %f %f %f %f %f %s %s %d32 %s', 'HeaderLines',1, 'Delimiter', '\t');
